...
class _RegisterState extends State<Register> {
  ...
  Widget build(BuildContext context) {
      ...
      child: MaterialButton(
        ...
        onPressed: () async{
          if (_formKey.currentState.validate()){
            dynamic result = await authServise.registerWithEmailAndPassword(email, password);
            if(result == null) {
              setState(() {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
            elevation: 0.0,
            title: Text("Register to Garage Sale"),
          actions: <Widget>[
            FlatButton.icon(
                onPressed: (){
                  widget.toggleView();
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      //decoration: testInputDecoration.copyWith(hintText: "Email"),
                    ...
                    TextFormField(
                      //decoration: testInputDecoration.copyWith(hintText: "Password", ),
